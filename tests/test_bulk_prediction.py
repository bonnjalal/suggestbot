...
#     print(
#         "{0} last revision of {1}, and prediction of {2}".format(
#             page.title(), page.latest_revision_id, page.get_prediction()
#         )
#     )
...
for page in sup.PredictionGenerator(site, pagelist):
    ...
    print(
        "{0} has a page ID of {1}, last revision of {2}, and prediction of {3}".format(
            page.title(), page._pageid, page.latest_revision_id, page.get_prediction()
        )
    )
